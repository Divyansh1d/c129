...
if(drawnsketch==sketch){
 ...
 function updateCanvas(){
   ...
   quick_draw_data_set=sketch;
   document.getElementById("guessed_sketch").innerHTML=sketch;
 }
...
function gotResult(){
  ...
  console.log(results);
  drawnsketch= 'Your Sketch:'+results[0].label;
  document.getElementById("guessed_sketch").innerHTML=drawnsketch;
